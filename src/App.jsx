  ...
  return (
    <div className="min-h-screen p-2 sm:p-4" style={{
      ...
      <div className="max-w-7xl mx-auto">
        <div className="wood-border p-4 sm:p-6 mb-4 rounded-lg">
          ...
          <div className="flex items-center justify-between mb-2 flex-wrap gap-2">
            <div className="flex items-center gap-2">
              ...
              <div className="parchment-texture px-3 py-1 rounded text-xs stat-label ink-text">Turn {turn}</div>
              {ships.length > 0 && (
                <div className="parchment-texture px-3 py-1 rounded text-xs stat-label ink-text">{ships.length} Ships</div>
              )}
            </div>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <select
                ...
                className="parchment-input rounded px-2 py-1 text-xs"
              >
        ...
        {activeTab === 'ships' && (
          <div className="space-y-3">
            <div className="wood-border p-4 sm:p-6 rounded-lg">
              ...
              <div className="space-y-3">
                <div>
                  <label className="stat-label block mb-1 ink-text">Ship Name</label>
                  <input
                    value={shipForm.name}
                    onChange={(e) => setShipForm(prev => ({ ...prev, name: e.target.value }))}
                    className="w-full parchment-input rounded px-3 py-2 text-sm"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="stat-label block mb-1 ink-text">Ship Class</label>
                    <select
                  ...
                  <div>
                    <label className="stat-label block mb-1 ink-text">Tonnage</label>
                    <input
                      type="number"
                      value={shipForm.tonnage}
                      onChange={(e) => setShipForm(prev => ({ ...prev, tonnage: parseInt(e.target.value) }))}
                      className="w-full bg-[#3a2f1f] border-2 border-[#2a1f0f] shadow-inner rounded px-2 py-1 text-xs"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2">
                  <div>
                    <label className="stat-label block mb-1 ink-text">Sails</label>
                    <select
                  ...
                  <div>
                    <label className="stat-label block mb-1 ink-text">Crew</label>
                    <input
                      type="number"
                      value={shipForm.crew}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2">
                  <div>
                    <label className="stat-label block mb-1 ink-text">Quality</label>
                    <select
                  ...
                  <div>
                    <label className="stat-label block mb-1 ink-text">Nationality</label>
                    <select
                  ...
                  {shipForm.guns.map((gun, idx) => (
                    <div key={idx} className="flex gap-1 mb-1">
                      <select
                        ...
                        className="flex-1 bg-[#3a2f1f] border-2 border-[#2a1f0f] shadow-inner rounded px-1 py-1 text-xs"
                      >
                      ...
                      <input
                        ...
                        className="w-12 bg-[#3a2f1f] border-2 border-[#2a1f0f] shadow-inner rounded px-1 py-1 text-xs"
                      />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2">
                  <div>
                    <label className="stat-label block mb-1 ink-text">Bow Chasers</label>
                    <div className="flex gap-1">
                      ...
                      <input
                        ...
                        className="w-10 bg-[#3a2f1f] border-2 border-[#2a1f0f] shadow-inner rounded px-1 py-1 text-xs"
                      />
                    </div>
                  </div>
                  <div>
                    <label className="stat-label block mb-1 ink-text">Stern Chasers</label>
                    <div className="flex gap-1">
                      <select
            ...
            <div className="space-y-2">
              {ships.map(ship => (
                <div key={ship.id} className="bg-[#4a3f2f] text-[#e8dfc8] rounded border-4 border-[#2a1f0f] shadow-2xl-lg p-2 border border-[#2a1f0f]">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-bold text-xs sm:text-sm">{ship.name}</h3>
                    ...
                    {ship.grappled ? (
                      ...
                      <div className="flex items-center gap-2">
                        <select
                          ...
                          className="flex-1 bg-[#3a2f1f] border-2 border-[#2a1f0f] shadow-inner rounded px-2 py-1 text-xs"
                          defaultValue=""
                        >
        ...
        {activeTab === 'movement' && (
          <div className="wood-border p-4 sm:p-6 rounded-lg">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-xs sm:text-sm font-bold">Movement Calculator</h2>
              <div className="flex items-center gap-2">
                <input
                  type="checkbox"
                ...
                return (
                  <div key={ship.id} className="bg-[#3a2f1f] text-[#d9d0b8] rounded p-2 sm:p-3 mb-3 border-2 border-[#2a1f0f] shadow-inner">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-2 mb-2">
                      <div>
                        <label className="stat-label block mb-1 ink-text">Point of Sail</label>
                        <select
                          value={ship.pos}
                          onChange={(e) => {
                          ...
                          className="w-full bg-[#4a3f2f] border border-[#1a1410] rounded px-2 py-1 text-xs"
                        >
                      ...
                      <div>
                        <label className="stat-label block mb-1 ink-text">
                      ...
                      <div>
                        <label className="stat-label block mb-1 ink-text">Last Move (mm)</label>
                        <input
                          type="number"
                          value={ship.lastMove}
                          min="0"
        ...
        {activeTab === 'gunnery' && (
          <div className="wood-border p-4 sm:p-6 rounded-lg">
            ...
            <div className="space-y-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2">
                <div>
                  <label className="stat-label block mb-1 ink-text">Firing Ship</label>
                  <select
                ...
                <div>
                  <label className="stat-label block mb-1 ink-text">Target Ship</label>
                  <select
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-2">
                <div>
                  <label className="stat-label block mb-1 ink-text">Firing Arc</label>
                  <select
                ...
                <div>
                  <label className="stat-label block mb-1 ink-text">Target Location</label>
                  <select
                ...
                <div>
                  <label className="stat-label block mb-1 ink-text">Distance</label>
                  <input
                    type="number"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2">
                <div>
                  <label className="stat-label block mb-1 ink-text">Shot</label>
                  <select
                ...
                <div>
                  <label className="stat-label block mb-1 ink-text">Aim</label>
                  <select
              ...
              <div className="grid grid-cols-1 gap-2">
                <div>
                  <label className="stat-label block mb-1 ink-text">Rake</label>
                  <select
              ...
              {lastGunneryResult && (
                <div className="mt-2 p-2 bg-green-900/20 border-2 border-green-600 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button onClick={() => setLastGunneryResult(null)} className="px-2 py-0.5 bg-[#3a2f1f] rounded text-xs">
                      Clear
                    </button>
                  </div>
                            ...
                            <button
                              ...
                              className={`flex-1 px-2 py-1 rounded text-xs font-medium ${
                                ship.organizedFireParty 
                                  ...
                                  : 'bg-[#3a2f1f] text-[#3a2f1e] hover:bg-[#2a1f0f]'
                              }`}
                            >
                            ...
                            <button
                              ...
                              className={`flex-1 px-2 py-1 rounded text-xs font-medium ${
                                ship.magazineFlooded
                                  ...
                                  : 'bg-red-700 text-white hover:bg-[#a52a2a]'
                              }`}
                              type="button"
                            >
        ...
        {activeTab === 'crew' && (
          <div className="wood-border p-4 sm:p-6 rounded-lg">
            <h2 className="text-xs sm:text-sm font-bold mb-3">👥 Crew Management (Optional M.0)</h2>
            
            {ships.map(ship => (
              <div key={ship.id} className="bg-[#3a2f1f] text-[#d9d0b8] rounded p-2 sm:p-3 mb-3">
                <div className="flex justify-between items-center mb-2">
                  <h3 className="text-xs sm:text-sm font-bold">{ship.name}</h3>
            ...
            <div className="space-y-1 max-h-96 overflow-y-auto">
              {log.slice().reverse().map(entry => (
                <div key={entry.id} className={`text-xs p-2 rounded ${
                  ...
                  'bg-[#3a2f1f] text-[#3a2f1e]'
                }`}>
                  <span className="text-[#a8966d]">[T{entry.turn}]</span> {entry.message}
                </div>
              ))}
            </div>
          </div>
        ...
        {showResetConfirm && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-2 sm:p-4 z-50">
            <div className="bg-[#4a3f2f] text-[#e8dfc8] rounded border-4 border-[#2a1f0f] shadow-2xl-lg p-2 sm:p-4 border-2 border-red-600 max-w-sm">
              ...
              <p className="text-[#3a2f1e] mb-2 sm:mb-4 text-xs sm:text-sm">All progress will be lost. Are you sure?</p>
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-[#2a1f0f] hover:bg-[#3a2f1f] rounded font-bold text-xs sm:text-sm"
                >
                  Cancel
                </button>
              </div>
        ...
        {showRestartConfirm && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-2 sm:p-4 z-50">
            <div className="bg-[#4a3f2f] text-[#e8dfc8] rounded border-4 border-[#2a1f0f] shadow-2xl-lg p-2 sm:p-4 border-2 border-yellow-600 max-w-sm">
              ...
              <p className="text-[#3a2f1e] mb-2 sm:mb-4 text-xs sm:text-sm">Go back to the previous turn?</p>
              <div className="flex gap-2">
                <button
